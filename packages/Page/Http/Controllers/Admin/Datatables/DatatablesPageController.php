...
class DatatablesPageController extends Controller
{
    public function getListAjax(Request $request){
        ...
        return Datatables::of($pages)
            ...
            ->addColumn('action', '<a href="{{ route("admin.page.post.edit",$id) }}" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Edit">
                                        <i class="fa fa-pencil"></i></a> 
                                    <a href="{{ route("admin.page.get.delete",$id) }}" class="btn btn-danger btn-sm" title="Delete" data-toggle="tooltip">
