...
class CoreModuleCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'cms:module {name}';
    ...
    protected function http($module){
        ...
        mkdir(base_path("packages/{$module}/Http/Controllers"), 0777, true);
...
";
$fp = fopen(base_path("packages/{$module}/Http/routes.php"),"wb");
fwrite($fp,$content);
fclose($fp);
...
namespace TTSoft\\{$module}\\Http\Controllers;
...
$fp = fopen(base_path("packages/{$module}/Http/Controllers/{$module}Controller.php"),"wb");
...
class BaseRouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected {namespace} = 'TTSoft\\{$module}\\Http\Controllers';
...
";
$route = str_replace('{namespace}', '$namespace', $route);
