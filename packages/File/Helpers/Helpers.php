...
function addJs(){
	$js = '';
	$js .= '<script type="text/javascript" src="/vendor/packages/ckfinder/ckfinder.js"></script>';
	$js .= '<script type="text/javascript" src="/vendor/packages/ckeditor/ckeditor.js"></script>';
	echo $js;
}
